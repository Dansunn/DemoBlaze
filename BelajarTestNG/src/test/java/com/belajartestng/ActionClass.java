...
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(1));
    ...
    public void osloTest() {
        ...
        WebElement droppable = driver.findElement(By.id("101"));

        Action action = actions.clickAndHold(draggable).moveToElement(droppable).build();

        action.perform();
        System.out.println(draggable.getCssValue("background-color"));
